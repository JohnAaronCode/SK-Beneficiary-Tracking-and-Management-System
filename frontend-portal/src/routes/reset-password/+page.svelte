...
<div class="min-h-screen flex items-center justify-center p-4" style="background: #0A1F44;">
  <div class="flex flex-col items-center w-full max-w-sm">
    ...
    <div class="w-full border rounded-2xl px-8 py-8"
      ...
      {:else}
        <p class="text-white/60 text-xs font-semibold uppercase tracking-widest mb-4">Create your new password</p>

        <form onsubmit={(e) => { e.preventDefault(); handleReset(); }} class="space-y-3">

          <div class="relative">
            <Lock size={14} class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none"
